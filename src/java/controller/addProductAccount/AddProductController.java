...
public class AddProductController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String discount = request.getParameter("P_discount");
        String description = request.getParameter("P_description");
        String dateadd = request.getParameter("P_dateadd");
        ...
        DAO dao = new DAO();
        dao.addProduct(code, name, color, cate_id, price, size, image, discount, description, dateadd, sell_id);
